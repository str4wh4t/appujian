...
//        $image_file = K_PATH_IMAGES.'logo_example.jpg';
        ...
        $this->SetY(18);
        $this->SetX(60);
        $this->Cell(0, 15, strtoupper(get_app_author()), 0, false, 'T', 0, '', 0, false, 'M', 'M');
        $this->SetY(28);
        $this->SetX(60);
...
<p style="text-align: center">
Telah mengikuti {$nama_ujian} pada tanggal {$tgl_ujian_format} dengan hasil sebagai berikut :
</p>
...
<p style="text-align: center; ">
Sertifikat dapat divalidasi melalui <a href="{$link}">{$base_url}</a>
</p>
EOD;
