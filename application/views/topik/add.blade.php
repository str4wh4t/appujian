...
<script src="{{ asset('assets/dist/js/app/master/topik/add.js') }}"></script>
<!-- END PAGE LEVEL JS-->
@endpush
                    ...
                    <tr>
                        ...
                        <td width="200">
                            <div class="form-group">
                                <select name="matkul_id[<?=$i?>]" class="form-control input-sm select2" style="width: 100%!important">
                        ...
                        <td>
                            <div class="form-group">
                                <input autofocus="autofocus" onfocus="this.select()" autocomplete="off" type="text" name="nama_topik[<?=$i?>]" class="form-control">
                        ...
                        <td  width="150">
                            <div class="form-group">
                                <input autocomplete="off" type="text" class="form-control inp_decimal" name="poin_topik[<?=$i?>]" value="1">
                                <span class="d-none">DON'T DELETE THIS</span>
                                <small class="help-block text-right"></small>
                            </div>
                        </td>
