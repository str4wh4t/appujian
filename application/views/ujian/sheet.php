    ...
    <div class="col-sm-9">
        ...
        <div class="box box-primary">
            ...
            <div class="box-footer text-center">
	            ...
	            <button type="button" class="ragu_ragu btn btn-warning" rel="1" onclick="return tidak_jawab();" disabled="disabled">Ragu-ragu</button>
...
<script src="<?=base_url('assets/dist/js/app/ujian/sheet.js?u=' . round(microtime(true)))?>"></script>
