...
function init_page_level(){
    ...
    cascadLoading.then( function(parent, child, items) {
        ...
        init_topik_table_value(); // TO RESET ALL DATA TABLE JML SOAL
...
{{--            </div>--}}
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" class="switchBootstrap" id="tampilkan_tutorial" name="tampilkan_tutorial" data-on-text="Tampilkan" data-off-text="Tidak" data-radio-all-off="true" data-on-color="success" data-off-color="danger" />
                    </div>
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="tbody_tb_peserta">
                            <tr>
                                <td colspan="3">Tidak ada peserta tersedia</td>
                            </tr>
                        </tbody>
                    </table>
                    <small class="help-block"></small>
