...
@push('page_level_js')
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{ asset('assets/dist/js/app/master/jurusan/index.js') }}"></script>
...
<div class="box">
    <div class="box-body">
		<div class="mb-4">
            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-outline-primary btn-flat"><i class="fa fa-plus"></i> Tambah Data</button>
            <a href="{{ site_url('jurusan/import') }}" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import</a>
