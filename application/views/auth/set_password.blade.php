                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('auth/set_password/' . $code, ['id'=>'form', 'class'=>'form-horizontal', 'novalidate'=>'', 'method'=>'POST'], ['user_id' => $user->id]); ?>
                            <fieldset class="form-group position-relative has-icon-left">
                                ...
                                <input type="password" name="new" value="" id="new" placeholder="New Password" autofocus="autofocus" class="form-control" autocomplete="off">
                            ...
                            <fieldset class="form-group position-relative has-icon-left">
                                ...
                                <input type="password" name="new_confirm" value="" id="new_confirm" placeholder="New Password Again" autofocus="autofocus" class="form-control" autocomplete="off">
                                <span class="help-block"></span>
                            </fieldset>
                            <button type="submit" class="btn btn-outline-info btn-block" id="btn_submit_password">Submit</button>
                        <?= form_close() ?>
                    </div>
                </div>
            </div>
