                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <table class="table table-bordered" id="tb_identitas_peserta">
                                ...
                                <tr>
                                    <th colspan="2" style="text-align: center"><img src="{{ $_ENV['APP_TYPE'] == 'tryout' ? asset('assets/imgs/no_profile_120_150.jpg') : $h_ujian->mhs->foto }}" style="height: 150px; width: 120px;" /></th>
                                </tr>
                                <tr>
                                    <th>Ujian</th>
