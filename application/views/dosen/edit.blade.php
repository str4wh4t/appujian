...
function init_page_level(){
    ...
    let selected = [];
    @foreach($dosen->matkul as $dosen_matkul)
    selected.push('{{ $dosen_matkul->id_matkul }}');
    @endforeach
...
<script src="{{ asset('assets/dist/js/app/master/dosen/edit.js') }}"></script>
<!-- END PAGE LEVEL JS-->
@endpush
        ...
        <div class="form-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input value="<?=$data->nama_dosen?>" autofocus="autofocus" onfocus="this.select()" type="text" class="form-control" name="nama_dosen" placeholder="Nama Dosen">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input  value="<?=$data->tgl_lahir?>" placeholder="Tgl Lahir" type="text" name="tgl_lahir" class="datetimepicker form-control">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
