                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6 offset-md-3">
                                    ...
                                    <div class="text-center">
                                        <a data-toggle="modal" href="#materiId" style="text-decoration:none"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="form-group">
                                            <input type="file" name="upload_file"
                                                style="border: 3px solid #000; padding: 3px;">
                                        </div>
                            ...
                            <div class="row">
                                    ...
                                    foreach ($import as $data) :
                                        ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td
                                                        class="<?= ($data['topik_id'] == null || $data['topik_id'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['topik_id'] == null || $data['topik_id'] == '!! ERROR !!') ? '!! ERROR !!' : $data['topik']->nama_topik; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['soal'] == null || $data['soal'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['soal'] == null || $data['soal'] == '!! ERROR !!') ? '!! ERROR !!' : $data['soal']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['opsi_a'] == null || $data['opsi_a'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['opsi_a'] == null || $data['opsi_a'] == '!! ERROR !!') ? '!! ERROR !!' : $data['opsi_a']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['opsi_b'] == null || $data['opsi_b'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['opsi_b'] == null || $data['opsi_b'] == '!! ERROR !!') ? '!! ERROR !!' : $data['opsi_b']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['opsi_c'] == null || $data['opsi_c'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['opsi_c'] == null || $data['opsi_c'] == '!! ERROR !!') ? '!! ERROR !!' : $data['opsi_c']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['opsi_d'] == null || $data['opsi_d'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['opsi_d'] == null || $data['opsi_d'] == '!! ERROR !!') ? '!! ERROR !!' : $data['opsi_d']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['opsi_e'] == null || $data['opsi_e'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['opsi_e'] == null || $data['opsi_e'] == '!! ERROR !!') ? '!! ERROR !!' : $data['opsi_e']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['jawaban'] == null || $data['jawaban'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['jawaban'] == null || $data['jawaban'] == '!! ERROR !!') ? '!! ERROR !!' : $data['jawaban']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['bobot_soal_id'] == null || $data['bobot_soal_id'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['bobot_soal_id'] == null || $data['bobot_soal_id'] == '!! ERROR !!') ? '!! ERROR !!' : $data['bobot_soal']->bobot; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['gel'] == null || $data['gel'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['gel'] == null || $data['gel'] == '!! ERROR !!') ? '!! ERROR !!' : $data['gel']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['smt'] == null || $data['smt'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                                        <?= ($data['smt'] == null || $data['smt'] == '!! ERROR !!') ? '!! ERROR !!' : $data['smt']; ?>
                                                    </td>
                                                    <td
                                                        class="<?= ($data['tahun'] == null || $data['tahun'] == '!! ERROR !!') ? 'bg-danger text-white' : ''; ?>">
                                ...
                                ?>
                                    ...
                                    <button type='submit' class='btn btn-block btn-flat btn-primary'><i
                                            class="fa fa-arrow-circle-o-up"></i> Import</button>
                                    <?= form_close(); ?>
                                    <?php endif; ?>
                                    <br>
                                    <?php endif; ?>
