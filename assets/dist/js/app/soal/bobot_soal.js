...
$(document).ready(function() {
  ...
  table = $("#bobot_soal").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: base_url + "soal/ajax/data_bobot_soal",
      type: "POST"
    },
    columns: [
      { data: "bobot" },
    ...
    columnDefs: [
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="btn-group"><a class="btn btn-sm btn-warning" href="${base_url}soal/edit_bobot_soal/${data}">
										<i class="fa fa-pencil"></i>
									</a>
                    <a class="btn btn-sm btn-danger" href="${base_url}soal/delete_bobot_soal/${data}" onclick="return confirm('Yakin akan dihapus ?')">
