...
<script src="{{ asset('assets/dist/js/app/relasi/kelasdosen/index.js') }}"></script>
<!-- END PAGE LEVEL JS-->
@endpush
...
<div class="box">
    <div class="box-body">
		<div class="mb-4">
            <a href="{{ site_url('kelasdosen/add') }}" class="btn btn-sm btn-flat btn-outline-primary"><i class="fa fa-plus"></i> Tambah</a>
