...
// defined('APP_NAME')      OR define('APP_NAME', APP_ID == 'ujian.undip.ac.id' ? 'UNDIP UJIAN ONLINE' : 'UNDIP CAT');
// defined('APP_COLOR_NAV')      OR define('APP_COLOR_NAV', APP_ID == 'ujian.undip.ac.id' ? '#6061b3' : '#7a8ddc'); // #60a5b3
// defined('APP_BG_LOGIN')      OR define('APP_BG_LOGIN', APP_ID == 'ujian.undip.ac.id' ? 'img_big_login' : 'img_big_login_cat');
...
// defined('SHOW_REGISTRATION')      OR define('SHOW_REGISTRATION', false);

// defined('DB_HOSTNAME')      OR define('DB_HOSTNAME', '10.37.19.27');
// defined('DB_USERNAME')      OR define('DB_USERNAME', 'idris');
// defined('DB_PASSWORD')      OR define('DB_PASSWORD', 'q1w2e3r4');
// defined('DB_NAME')      OR define('DB_NAME', APP_ID == 'ujian.undip.ac.id' ? 'ujian' : 'oltest');

// // defined('DB_HOSTNAME')      OR define('DB_HOSTNAME', 'localhost');
// // defined('DB_USERNAME')      OR define('DB_USERNAME', 'root');
// // defined('DB_PASSWORD')      OR define('DB_PASSWORD', 'root');
// // defined('DB_NAME')      OR define('DB_NAME', 'ujianundip');

// JOLODONG

/*** TRYOUT */

defined('APP_ID')      OR define('APP_ID', 'tryout.undip.id');
...
defined('PAKET_MATERI_ID_DEFAULT')      OR define('PAKET_MATERI_ID_DEFAULT', [1]);
defined('SHOW_REGISTRATION')      OR define('SHOW_REGISTRATION', true);

// defined('DB_HOSTNAME')      OR define('DB_HOSTNAME', '10.170.0.6');
// defined('DB_USERNAME')      OR define('DB_USERNAME', 'db_tryout_dev');
// defined('DB_PASSWORD')      OR define('DB_PASSWORD', '2E5uViDA1Oyu');
// defined('DB_NAME')      OR define('DB_NAME', 'db_tryout');
