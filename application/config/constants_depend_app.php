...
// defined('APP_NAME')                 OR define('APP_NAME', 'UNDIP UJIAN ONLINE');
...
// defined('SHOW_DETAIL_HASIL')        OR define('SHOW_DETAIL_HASIL', false);
...
// defined('APP_NAME')                     OR define('APP_NAME', 'UNDIP CAT');
// defined('APP_COLOR_NAV')                OR define('APP_COLOR_NAV', '#7a8ddc'); // #60a5b3
// defined('APP_BG_LOGIN')                 OR define('APP_BG_LOGIN', 'img_big_login_cat');
// defined('APP_FAVICON_APPLE')            OR define('APP_FAVICON_APPLE', 'apple-touch-icon-cat');
// defined('APP_FAVICON')                  OR define('APP_FAVICON', 'favicon_cat');
// defined('APP_ICON')                     OR define('APP_ICON', 'android-chrome-512x512-cat');
// defined('ADMIN_EMAIL')                  OR define('ADMIN_EMAIL', 'cat@undip.ac.id');
// defined('MEMBERSHIP_ID_DEFAULT')        OR define('MEMBERSHIP_ID_DEFAULT', 0);
// defined('SHOW_REGISTRATION')            OR define('SHOW_REGISTRATION', false);
// defined('SHOW_DETAIL_HASIL')            OR define('SHOW_DETAIL_HASIL', false);
