...
<div class="row">
    <div class="col-md-6">
    <?=form_open('soal/ajax/save_bobot_soal', array('id'=>'bobot_soal'), array('method'=>'add'));?>
        <div class="form-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="nip">Bobot</label>
                        <input autofocus="autofocus" onfocus="this.select()" type="text" id="bobot" class="form-control" name="bobot" placeholder="Bobot">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                        <label for="nama_dosen">Nilai</label>
                        <input type="text" class="form-control inp_decimal" name="nilai" placeholder="nilai">
                        <small class="help-block"></small>
                    </div>
