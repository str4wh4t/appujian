...
defined('APP_NAME')      OR define('APP_NAME', APP_ID == 'ujian.undip.ac.id' ? 'UJIAN ONLINE UNDIP' : 'CAT UNDIP');
defined('APP_COLOR_NAV')      OR define('APP_COLOR_NAV', APP_ID == 'ujian.undip.ac.id' ? '#60a5b3' : '#7a8ddc');
