...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/npm/node_modules/summernote/dist/summernote-bs4.min.css') }}"><link rel="stylesheet" type="text/css" href="{{ asset('assets/npm/node_modules/summernote/dist/summernote-bs4.min.css') }}">
<!-- END PAGE LEVEL JS-->
@endpush
...
<div class="row">
    <div class="col-md-6">
    <?=form_open('paket/ajax/save_paket', ['id'=>'paket_ujian'], ['method' => 'post', 'aksi' => 'add']); ?>
        <div class="form-body">
            <div class="row">
                <div class="col-md-12">
