...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/node_modules/enjoyhint.js/dist/enjoyhint.css') }}">
<!-- END PAGE LEVEL JS-->
@endpush
...
<script src="{{ asset('assets/node_modules/kinetic/kinetic.min.js') }}"></script>
<script src="{{ asset('assets/node_modules/jquery.scrollto/jquery.scrollTo.min.js') }}"></script>
<script src="{{ asset('assets/node_modules/enjoyhint.js/dist/enjoyhint.min.js') }}"></script>
<!-- END PAGE VENDOR JS -->
@endpush
...
let enjoyhint_script_steps = [
    ...
    {
        'next .funkyradio-success:visible:nth-child(3)': 'Terdiri 5 (lima) opsi jawaban (a, b, c, d, dan e), contoh : kita pilih jawaban "c"',
        "nextButton" : {className: "black border-amber btn-amber", text: "Lanjut"},
        'showSkip': false,
        'onBeforeStart': function () {
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <table class="table table-bordered" id="tb_identitas_peserta">
                                    ...
                                    <tr>
                                        <th>Jumlah Soal</th>
                                        <td>{{ JML_SOAL_TUTORIAL }} soal</td>
                                    </tr>
                                    <tr>
                                        <th>Waktu</th>
                                        <td>{{ JML_WAKTU_TUTORIAL }} menit</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <button class="btn btn-danger btn-block" id="btn_akhiri_ujian" type="button"><i
                                        class="fa fa-stop"></i> Akhiri Ujian</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body" id="pil_jawaban">
                                ...
                                </div><input type="hidden" name="id_soal_3" value="142">
