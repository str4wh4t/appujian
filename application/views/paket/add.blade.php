...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/yarn/node_modules/summernote/dist/summernote-bs4.min.css') }}"><link rel="stylesheet" type="text/css" href="{{ asset('assets/yarn/node_modules/summernote/dist/summernote-bs4.min.css') }}">
<!-- END PAGE LEVEL JS-->
@endpush
...
<div class="row">
    <div class="col-md-6">
    <?=form_open('paket/ajax/save_paket', array('id'=>'paket_ujian'), array('method' => 'post', 'aksi' => 'add'));?>
        <div class="form-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="name">Nama Paket</label>
                        <input autofocus="autofocus" onfocus="this.select()" value="" type="text" id="name" class="form-control" name="name" placeholder="Nama paket">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                        <label for="price">Harga</label>
                        <input value="" type="number" id="price" class="form-control" name="price" placeholder="Harga">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                        <label for="delete_price">Harga Hapus</label>
                        <input value="" type="number" id="delete_price" class="form-control" name="delete_price" placeholder="Harga Hapus">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                        <label for="description">Deskripsi</label>
                        <textarea id="description" name="description" class="form-control t_editor"></textarea>
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                        <label for="kuota_latihan_soal">Kuota Latihan Soal</label>
                        <input value="" type="number" id="kuota_latihan_soal" class="form-control" name="kuota_latihan_soal" placeholder="Kuota Latihan Soal">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input value="" type="number" id="urut" class="form-control" name="urut" placeholder="Urutan paket">
                        <small class="help-block"></small>
                    </div>
