...
//        $this->datatables->where('a.ujian_selesai', 'Y');
    ...
    {
        $this->db->select('d.id, a.nim, a.nama, 
        d.detail_bobot_benar, d.detail_nilai, 
        d.nilai, d.nilai_bobot_benar, b.masa_berlaku_sert, 
        b.tampilkan_jawaban, TIMESTAMPDIFF(SECOND, d.tgl_mulai, d.tgl_selesai) AS lama_pengerjaan, 
        d.tgl_mulai, d.tgl_selesai,
        d.mahasiswa_ujian_id, c.absen_by, c.absen_by_username, c.is_terlihat_pada_layar, c.is_perjokian, 
        c.is_sering_buka_page_lain, c.catatan_pengawas, 
        CONCAT(IF(d.started_by = "cron", "CRON", "SELF"), "/", IF(d.ended_by = "cron", "CRON", IF(d.ended_by = a.nim, "SELF", "PENGAWAS") ))  AS start_end_by');
