        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="text-center">
                    <a href="<?= base_url('uploads/import/format/matkul.xlsx') ?>" class="btn btn-outline-info btn-glow">Download Format</a>
                </div>
                <br>
                <div class="text-center">
                    ...
                    <button name="preview" type="submit" class="btn btn-sm btn-success"><i class="fa fa-th"></i> Preview</button> <a href="{{ site_url('matkul') }}" class="btn btn-sm btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
                     <?= form_close(); ?>
                </div>
            </div>
        </div>
