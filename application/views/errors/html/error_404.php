...
<head>
  ...
  <link href="<?= base_url('assets/node_modules/typeface-muli/index.css') ?>" rel="stylesheet">
  <link href="<?= base_url('assets/node_modules/typeface-open-sans/index.css') ?>" rel="stylesheet">
  <!-- BEGIN VENDOR CSS-->
