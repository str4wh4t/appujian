...
defined('APP_ID')                   OR define('APP_ID', 'tryout.exampel.id');
defined('APP_TYPE')                 OR define('APP_TYPE', 'tryout');
defined('SITE_TITLE')               OR define('SITE_TITLE', 'Tryout ExamPel');
defined('SITE_DESC')                OR define('SITE_DESC', 'Tryout exam atau ujian UTBK, SNMPTN, UM dan ujian pelajaran akademis lainnya secara mandiri dengan soal dari profesional disertai ulasan penjelasan yang mudah dimengerti');
defined('EMAIL_ACTIVATION')         OR define('EMAIL_ACTIVATION',  true);

defined('APP_NAME')                 OR define('APP_NAME', 'TRYOUT EXAMPEL');
...
defined('ADMIN_EMAIL')              OR define('ADMIN_EMAIL', 'help@exampel.id');
