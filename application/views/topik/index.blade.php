...
<script src="{{ asset('assets/dist/js/app/master/topik/index.js') }}"></script>
<!-- END PAGE LEVEL JS-->
@endpush
...
{{--			<a href="{{ site_url('topik/import') }}" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import</a>--}}
...
<div class="row">
    <div class="col-md-12">
	   ...
	   <div class="table-responsive pb-2">
		<table id="topik" class="table table-striped table-bordered table-hover w-100">
			<thead>
				<tr>
					<th>No.</th>
					<th>Materi Ujian</th>
